const CACHE_NAME = 'nycif-v017-event-feed-schema-v1';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
...
const NETWORK_FIRST_RE = /\/(?:index\.html|app-v06-safe\.js|event-feed-schema-v1\.js|all-source-data-explorer-v01\.js|public-map-defaults-v01\.js|service-worker\.js|public-approved-overlays-v01\.js|public-approved-overlays-capture-v01\.js)$/;
