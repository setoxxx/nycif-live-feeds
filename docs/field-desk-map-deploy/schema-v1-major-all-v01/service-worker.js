const CACHE_NAME = 'nycif-v018-schema-v1-major-all-v01';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
...
const NETWORK_FIRST_RE = /\/(?:index\.html|app-schema-v1-major-all-v01\.js|event-feed-schema-v1\.js|public-map-defaults-v01\.js|service-worker\.js|public-approved-overlays-v01\.js|public-approved-overlays-capture-v01\.js)$/;
