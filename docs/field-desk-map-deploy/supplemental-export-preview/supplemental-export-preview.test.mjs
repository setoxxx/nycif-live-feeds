...
test('standalone preview html uses cache bust v=12', () => {
  assert.match(previewHtml, /supplemental-approved-export-preview-v01\.js\?v=12/);
...
test('formatMapRenderMeta reports cap when viewport exceeds soft cap', () => {
  ...
  assert.match(capped, /3,491 loaded total/);
