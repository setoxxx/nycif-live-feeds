 ...
 * Description: Embeds the NYC In Focus live event map (GitHub Pages) with staged feed data from nycif-live-feeds. Emergency map restore 1.2.2.
 * Version: 1.2.2
 * Author: NYC In Focus
...
define('NYCIF_EVENTS_MAP_VERSION', '1.2.2');
 ...
 *   cache  — cache-bust query string (default map-restore-v02)
 */
...
function nycif_events_map_settings_render() {
    ...
    <div class="wrap">
        ...
        <table class="form-table">
            ...
            <tr><th>Default iframe query</th><td><code>?v=map-restore-v02&amp;resetFilters=1</code></td></tr>
        ...
        <p><strong>Deploy note (1.2.2):</strong> Merge and deploy the Field Desk emergency map restore to GitHub Pages before uploading this plugin ZIP. This plugin is an iframe wrapper only and does not fetch the 32k-event JSON.</p>
    </div>
    <?php
}
