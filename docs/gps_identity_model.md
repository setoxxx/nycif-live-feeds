...
apply_gps_staged_feed_integration_update.py
  ...
  -> M7-B.2 count-contract preflight: safe_update_count_contract must be present, schema-valid, provenance-bound, and arithmetically consistent before identity work
